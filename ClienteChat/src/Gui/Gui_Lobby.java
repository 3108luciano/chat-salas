...
public class Gui_Lobby extends JFrame {
	...
	public  void agregarCliente(String nick) {
	...
	public synchronized DefaultListModel<String> getModeloSalas() {
		return modeloSalas;
	}

	public void setModeloSalas(DefaultListModel<String> modeloSalas) {
		this.modeloSalas = modeloSalas;
	}

	public synchronized DefaultListModel<String> getModeloClientes() {
